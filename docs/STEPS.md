...
* `writeJSON` - Write a [JSON](http://www.json.org/json-it.html) object to a files in the workspace, or return a string with the encoded json. ([help](../src/main/resources/org/jenkinsci/plugins/pipeline/utility/steps/json/WriteJSONStep/help.html))
